...
export interface AvailDABridgeUnproxiedInterface extends utils.Interface {
  functions: {
...
export interface AvailDABridgeUnproxied extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AvailDABridgeUnproxiedInterface;
