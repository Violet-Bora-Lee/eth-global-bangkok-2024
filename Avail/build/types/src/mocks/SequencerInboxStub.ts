...
export interface SequencerInboxStubInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "daBridge", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "daBridge", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "dasKeySetInfo",
    data: BytesLike
  ): Result;
...
export interface SequencerInboxStub extends BaseContract {
  ...
  functions: {
    ...
    daBridge(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    daBridge(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    daBridge(overrides?: CallOverrides): Promise<PopulatedTransaction>;
