...
export declare namespace BridgeCreator {
  export type BridgeContractsStruct = {
    ...
    dabridge: PromiseOrValue<string>;
  };
...
export interface BridgeCreatorInterface extends utils.Interface {
  functions: {
    ...
    "updateERC20Templates((address,address,address,address,address,address))": FunctionFragment;
    "updateTemplates((address,address,address,address,address,address))": FunctionFragment;
  };
