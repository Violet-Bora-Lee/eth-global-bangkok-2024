...
export interface RollupCreatorInterface extends utils.Interface {
  ...
  events: {
    ...
    "RollupCreated(address,address,address,address,address,address,address,address,address,address,address,address,address)": EventFragment;
...
export interface RollupCreator extends BaseContract {
  ...
  filters: {
    ...
    "RollupCreated(address,address,address,address,address,address,address,address,address,address,address,address,address)"(
